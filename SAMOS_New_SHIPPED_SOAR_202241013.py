...
from SAMOS_SOAR_dev.soar_tcs import SoarTCS
...
# #===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#===#=====
        ...
        button_RADEC_to_SOAR = tk.Button(labelframe_Query_Survey, text="Send to Telescope", bd=3,
                             command=self.send_RADEC_to_SOAR)
...
#        plt.figure(figsize=(8,8))
        ...
        print("RADEC of the field center:", ra,dec)
        ...
        self.string_RA_cntr_arcs.set(Delta_RA*3600.*np.cos(dec*math.pi/180.))
        self.string_DEC_cntr_arcs.set(Delta_DEC*3600.)
